...
The Kubernetes DaemonSet allows you to run a specific containerized workload on all nodes in the cluster. This is essential for infrastructure components, such as network agents, but may also be convenient for other types of workload. In this interactive lab you will learn how to create a DaemonSet by generating a YAML file and ensure this DaemonSet can schedule a Pod on the controller node as well.
...
Lab 2: [Certified Kubernetes - CKA: Creating a Manifest to run a DaemonSet](https://learning.oreilly.com/scenarios/certified-kubernetes-cka/9780137836116X002/) - &#8592; You are here
