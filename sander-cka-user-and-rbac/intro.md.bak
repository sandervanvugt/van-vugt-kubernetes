...
Kubernetes offers advanced options for working with users and role-based access control. In this interactive lab you will learn how to create Kubernetes user accounts and apply RBAC to grant specific permissions to the user. 
...
Lab 5: [Certified Kubernetes - CKA: Setting up a Kubernetes User Account and RBAC](https://learning.oreilly.com/scenarios/certified-kubernetes-cka/9780137836116X005/) - &#8592; You Are Here
