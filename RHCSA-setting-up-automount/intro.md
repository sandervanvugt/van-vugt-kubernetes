...
The autofs service is used to mount a directory only when accessed. In this lab you'll learn how to use it on exports that are provided by an NFS server
...
Lab 8: [RHCSA Lab - Setting up Automount](https://learning.oreilly.com/scenarios/rhcsa-scenarios-automount/9780137864942X008) - &#8592; You Are Here
