...
The autofs service is used to mount a directory only when accessed. In this scenario you'll learn how to use it on exports that are provided by an NFS server
...
Scenario 8: [RHCSA Scenario - Setting up Automount](https://learning.oreilly.com/scenarios/rhcsa-scenarios-automount/9780137864942X008) - &#8592; You Are Here
