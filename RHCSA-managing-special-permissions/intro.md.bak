...
To get your RHCSA, you'll need work with permissions. In this scenario you'll learn how to set up a shared group environment using the appropriate permissions using special permissions.
...
Scenario 6: [RHCSA Scenario - Managing Special Permissions](https://learning.oreilly.com/scenarios/rhcsa-scenarios-specialperm/9780137864942X006) - &#8592; You Are Here
