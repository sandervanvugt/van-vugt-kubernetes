...
Kubernetes offers advanced options for working with volumes, which can be configured internally as well as through Persistent Volumes provided by the cloud. In this interactive lab you will learn how to configure Pods to use Persistent Storage, thus allowing you to run stateful applications in Kubernetes.
...
Lab 1: [Certified Kubernetes - CKAD: Configuring Pod Storage](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X001/) - &#8592; You Are Here
