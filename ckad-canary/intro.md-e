...
Canary Deployments offer an application upgrade strategy, where zero application downtime is the main mission. The starting point is the old application, which is running multiple application instances, using Pods. The Canary Deployment strategy will bring in one instance of the new version, which allows for live testing of the application, without endangering all user connections in case it doesn't work out well. Once this single new version instance has prooved to be successful, the application upgrade can be completed. While using standard Kubernetes Resources, it's easy to implement Canary Deployments. This scenario will guide you through the procedure. 
...
Scenario 1: [Certified Kubernetes - CKAD: Configuring Pod Storage](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X001/) 

Scenario 2: [Certified Kubernetes - CKAD: Using Services to Expose Applications](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X002/)

Scenario 3: [Certified Kubernetes - CKAD: Troubleshooting Pod Problems](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X003/)

Scenario 4: [Certified Kubernetes - CKAD: Using ConfigMaps](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X004/)

Scenario 5: [Certified Kubernetes - CKAD: Using Canary Deployments](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X005/) - &#8592; You Are Here
