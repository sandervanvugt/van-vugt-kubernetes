...
While running application in Kubernetes, things may not work out as expected. If that happens, you'll need to analyze what is going wrong. In this scenario you'll learn how to use a methodology to troubleshoot applications in Kubernetes.
...
Scenario 3: [Certified Kubernetes - CKAD: Troubleshooting Pod Problems](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X003/) - &#8592; You Are Here
