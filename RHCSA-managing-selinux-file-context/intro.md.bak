...
SELinux is amongst the most difficult, but also amongst the most important topics in RHCSA. In this scenario you'll learn how to use it to secure an Apache web server.
 
In this scenario you will learn how to:
 
*	Configure Apache to use a non-default document root
...
Scenario 5: [RHCSA Scenario - Managing SELinux File Context](https://learning.oreilly.com/scenarios/rhcsa-scenarios-selinux/9780137864942X005) - &#8592; You Are Here
...
Challenge 3: [RHCSA Challenge - Managing Processes](https://learning.oreilly.com/scenarios/rhcsa-challenge/9780137864911X003)
