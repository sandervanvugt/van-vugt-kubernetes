...
Certified Kubernetes - CKA: Applying Quota to Namespaces and Applications
...
Kubernetes Quota allow for limiting access to Kubernetes resources. Working with quota involves setting them on namespaces, as well as associated resources. In this interactive scenario you will learn how to set quota to a namespace, and how to configure quota and resource limitations to applications to use them. 
...
Scenario 1: [Certified Kubernetes - CKA: Applying Quota to Namespaces and Applications](https://learning.oreilly.com/scenarios/certified-kubernetes-cka/9780137836116X004/) - You Are Here
