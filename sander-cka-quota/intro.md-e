...
Kubernetes Quota allow for limiting access to Kubernetes resources. Working with quota involves setting them on namespaces, as well as associated resources. In this interactive lab you will learn how to set quota to a namespace, and how to configure quota and resource limitations to applications to use them. 
