...
To get your RHCSA, you'll need to know how to work with storage. In this challenge lab you have to set up a complete storage environment that is based on the loop device. 
