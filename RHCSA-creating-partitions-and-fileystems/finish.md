...
*	How to use dd to create an image file
*	How to use losetup to create a loop device
*	How to use fdisk to create a partition
*	How to use mkfs to create a filesystem
*	How to use mount to connect the filesystem to a directory
*	How to use lsblk to verify status of currently mounted filesystems
