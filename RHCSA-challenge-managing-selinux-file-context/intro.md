...
SELinux is amongst the most difficult challenges on RHCSA. If you manage to complete this challenge, thatt really means you master SELinux! You are going to set up a vsftpd FTP server and configure it to allow anonymous user file uploads. 
