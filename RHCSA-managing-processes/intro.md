...
To get your RHCSA, you'll need to manage users and groups. In this scenario you'll learn how to set up defaults for new users, and how to create new users who will be a member of specific secondary groups.
