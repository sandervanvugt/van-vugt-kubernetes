...
To get your RHCSA, you'll need to manage users and groups. In this lab you'll learn how to set up defaults for new users, and how to create new users who will be a member of specific secondary groups.
...
Lab 4: [RHCSA Lab - Managing Processes](https://learning.oreilly.com/scenarios/rhcsa-scenarios-processes/9780137864942X004) - &#8592; You Are Here
