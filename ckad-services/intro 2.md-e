...
Kubernetes Service resources provide the standard way to expose applications for external access. In this scenario you'll learn how to create, test and troubleshoot Service resources. 
...
Scenario 2: [Certified Kubernetes - CKAD: Using Services to Expose Applications](https://learning.oreilly.com/scenarios/certified-kubernetes-ckad/9780137836185X002/) - &#8592; You Are Here
